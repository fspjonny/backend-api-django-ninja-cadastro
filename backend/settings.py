...
# NINJA_PAGINATION_CLASS = "persons.paginator.PersonPaginatorClass"
...
# Tempo de vida de uma sessão = 30 Minutos
SESSION_COOKIE_AGE = 1800

#Messageria constant flags
MESSAGE_TAGS = {
    constants.SUCCESS:'bg-green-500',
    constants.ERROR:'bg-red-400',
    constants.WARNING:'bg-orange-500',
}
